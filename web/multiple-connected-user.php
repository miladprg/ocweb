...
$multiple_users_connected = array_map(function ($value){
    $connection_detail = preg_split('/\s+/', $value, -1, PREG_SPLIT_NO_EMPTY);
    return [$connection_detail[1], $connection_detail[3]];
}, $online_users);


echo "debug";
var_dump($multiple_users_connected);
?>

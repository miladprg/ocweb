...
$file_path = "/etc/radcli/radiusclient.conf";
                ...
                <div class="col-lg-12">
                    <div class="todo-breadcrumb">
                        <div class="breadcrumb-main">
                            <h4 class="text-capitalize breadcrumb-title">ویرایش تنظیمات کاربران ردیوس</h4>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="card card-default card-md mb-4">
                                    <div class="card-header">
                                        <h6>ویرایش فایل کانفیگ Radius Client [radiusclient.conf]</h6>
                                    </div>

...
$file_path = "/etc/ocserv/ocserv.conf";
                ...
                <div class="col-lg-12">
                    <div class="todo-breadcrumb">
                        <div class="breadcrumb-main">
                            <h4 class="text-capitalize breadcrumb-title">ویرایش تنظیمات کاربران</h4>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="card card-default card-md mb-4">
                                    <div class="card-header">
                                        <h6>ویرایش فایل کانفیگ OCSERV</h6>
                                    </div>
                                    <div class="card-body pb-md-30">
                                        <form method="post">
                                            ...
                                            <div class="form-group form-element-textarea mt-2 mb-20">
                                                <textarea name="content" class="form-control" style="height: 600px" dir="ltr">
<?php print_r($content);?>
</textarea>
                                            </div>
                                        </form>
